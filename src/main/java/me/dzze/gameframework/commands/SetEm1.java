...
public class SetEm1 implements SubCommand {
    ...
    public void execute(CommandSender sender, String label, String[] args) {
        ...
        main.getConfig().set("Em1.world", p.getWorld().getName());
        main.getConfig().set("Em1.x", p.getLocation().getX());
        main.getConfig().set("Em1.y", p.getLocation().getY());
        main.getConfig().set("Em1.z", p.getLocation().getZ());
        main.saveConfig();

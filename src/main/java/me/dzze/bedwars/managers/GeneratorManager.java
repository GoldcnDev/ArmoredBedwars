...
public class GeneratorManager {
    ...
    public void startGens() {
        ...
        ArmorStand i1 = (ArmorStand) currentMap.spawnEntity(main.getConfig().getLocation(currentMap.getName() + ".Iron.1"), EntityType.ARMOR_STAND);
        i1.setGravity(false);
        ...
        ArmorStand i2 = (ArmorStand) currentMap.spawnEntity(main.getConfig().getLocation(currentMap.getName() + ".Iron.2"), EntityType.ARMOR_STAND);
        i2.setGravity(false);
        ...
        ArmorStand i3 = (ArmorStand) currentMap.spawnEntity(main.getConfig().getLocation(currentMap.getName() + ".Iron.3"), EntityType.ARMOR_STAND);
        i3.setGravity(false);
        ...
        ArmorStand i4 = (ArmorStand) currentMap.spawnEntity(main.getConfig().getLocation(currentMap.getName() + ".Iron.4"), EntityType.ARMOR_STAND);
        i4.setGravity(false);
        ...
        ArmorStand dia1 = (ArmorStand) currentMap.spawnEntity(main.getConfig().getLocation(currentMap.getName() + ".Dia.1"), EntityType.ARMOR_STAND);
        ...
        ArmorStand dia2 = (ArmorStand) currentMap.spawnEntity(main.getConfig().getLocation(currentMap.getName() + ".Dia.2"), EntityType.ARMOR_STAND);
        ...
        ArmorStand dia3 = (ArmorStand) currentMap.spawnEntity(main.getConfig().getLocation(currentMap.getName() + ".Dia.3"), EntityType.ARMOR_STAND);
        ...
        ArmorStand dia4 = (ArmorStand) currentMap.spawnEntity(main.getConfig().getLocation(currentMap.getName() + ".Dia.4"), EntityType.ARMOR_STAND);
        ...
        ArmorStand em1 = (ArmorStand) currentMap.spawnEntity(main.getConfig().getLocation(currentMap.getName() + ".Em.1"), EntityType.ARMOR_STAND);
        ...
        ArmorStand em2 = (ArmorStand) currentMap.spawnEntity(main.getConfig().getLocation(currentMap.getName() + ".Em.2"), EntityType.ARMOR_STAND);
    ...
    public void killGens() {
        for (Entity gens : GameManager.currentMap.getEntitiesByClasses(ArmorStand.class)) {
            gens.remove();
        }
        for (Entity ores : GameManager.currentMap.getEntities()) {
    ...
    public void createVillagers() {
        Villager is1 = (Villager) GameManager.currentMap.spawnEntity(null, EntityType.VILLAGER);
        is1.setSilent(true);
